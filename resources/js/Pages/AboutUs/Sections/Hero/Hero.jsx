      ...
      <div ref={teamRef} className={styles.team} style={{ opacity: 0 }}>
        ...
        <div className={styles.text}>
          ...
          <p className={styles.p}>
            <span style={{ fontWeight: 'bold' }}>Vibe Hive Digital Services</span> is a growth-focused digital studio based in the Philippines, serving ambitious brands across Asia and beyond.
            <br /><br />
