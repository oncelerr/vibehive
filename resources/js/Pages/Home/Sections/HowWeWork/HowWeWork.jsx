...
const steps = [
  {
    number: '1',
    title: 'Discovery',
    description: 'We start with a free 30-minute call to understand your business and goals. If there is a fit, we build a custom proposal.',
  ...
  },
  {
    ...
    description: 'We map your user journey, define the conversion strategy, and create designs that look great and perform even better.',
  ...
  },
  {
    ...
    description: 'Our development team brings designs to life with clean code, fast load times, and SEO foundations baked in.',
  ...
  },
  {
    ...
    description: 'We handle the launch, train your team on the CMS, and ensure everything works perfectly before we hand over the keys.',
