    ...
    <div className={styles.wrapper}>
      ...
      >
        ...
        <div className={styles.btncontainer}>
          {gradientBtn && <GradientBtn text={gradientBtn} hasArrow="true" color="gradient" func={() => navigate('/contact')}/>}
          {whiteBtn && <GradientBtn text={whiteBtn} color="white" func={() => navigate('/contact')}/>}
        </div>
      </div>
    </div>
  );
